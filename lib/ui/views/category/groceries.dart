          ...
          child: Positioned(
            ...
            child: Container(
              ...
              child: ListView.builder(
                  itemCount: foodNotifier.groceriesList.length,
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    foodNotifier.groceriesList[index].name,
                                    style: TextStyle(
                                        fontSize: 18,
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Text(
                                            "\RS ${foodNotifier.groceriesList[index].price}"),
                                        RaisedButton(
//
                                          color: Colors.red,
                                          ...
                                          onPressed: () {
                                            ...
                                            final snackBar = SnackBar(
                                              content: Text(
                                                  '${foodNotifier.groceriesList[index].name} added to Cart'),
                                              duration:
