          ...
          child: Positioned(
            ...
            child: Container(
              ...
              child: ListView.builder(
                  itemCount: foodNotifier.snackList.length,
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    foodNotifier.snackList[index].name,
                                    style: TextStyle(
                                        fontSize: 18,
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Text(
                                            "\RS ${foodNotifier.snackList[index].price}"),
                                        RaisedButton(
//
                                          color: Colors.red,
                                          ...
                                          onPressed: () {
                                            ...
                                            final snackBar = SnackBar(
                                              content: Text(
                                                  '${foodNotifier.snackList[index].name} added to Cart'),
                                              duration:
