...
class Detergent extends StatefulWidget {
  @override
  _DetergentState createState() => _DetergentState();
}
          ...
          child: Positioned(
            ...
            child: Container(
              ...
              child: ListView.builder(
                  itemCount: foodNotifier.detergentList.length,
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    foodNotifier.detergentList[index].name,
                                    style: TextStyle(
                                        fontSize: 18,
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Text(
                                            "\RS ${foodNotifier.detergentList[index].price}"),
                                        RaisedButton(
//
                                          color: Colors.red,
                                          ...
                                          onPressed: () {
                                            ...
                                            final snackBar = SnackBar(
                                              content: Text(
                                                  '${foodNotifier.detergentList[index].name} added to Cart'),
                                              duration:
