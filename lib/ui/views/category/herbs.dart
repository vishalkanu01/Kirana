          ...
          child: Positioned(
            ...
            child: Container(
              ...
              child: ListView.builder(
                  itemCount: foodNotifier.herbList.length,
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: NetworkImage(
                                          foodNotifier.herbList[index].image))),
                            ),
                          ),
                          Expanded(
                            flex: 8,
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    foodNotifier.herbList[index].name,
                                    style: TextStyle(
                                        fontSize: 18,
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Text(
                                            "\RS ${foodNotifier.herbList[index].price}"),
                                        RaisedButton(
//
                                          color: Colors.red,
                                          ...
                                          onPressed: () {
                                            ...
                                            final snackBar = SnackBar(
                                              content: Text(
                                                  '${foodNotifier.herbList[index].name} added to Cart'),
                                              duration:
